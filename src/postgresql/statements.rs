...
// TABLES constants
const TABLES_SELECT: &'static str = "SELECT \
...
lazy_static! {
    ...
    pub static ref DATABASES: String = format!("{}", DATABASE_SELECT.replace("{}", FIELD_DATABASE_NAME)) + DATABASE_WHERE +
        &format!("{}", DATABASE_ORDERBY.replace("{}", FIELD_DATABASE_NAME));
    ...
    pub static ref SCHEMAS: String = format!("{}", SCHEMAS_SELECT.replace("{}", FIELD_SCHEMA_NAME)) +
        &format!("{}", SCHEMAS_ORDERBY.replace("{}", FIELD_SCHEMA_NAME));


    pub static ref TABLES: String = format!("{} {} {}", TABLES_SELECT, TABLES_WHERE, TABLES_ORDERBY);

    pub static ref SCHEMA_TABLES: String = format!("{} {} {}", SCHEMA_TABLES_SELECT, SCHEMA_TABLES_WHERE, SCHEMA_TABLES_ORDERBY);
